...
export const getDialogList = async ({ pageNum, pageSize, clientUserName, firstChatTimeBegin,
  firstChatTimeEnd, lastChatTimeBegin, lastChatTimeEnd, serviceUserId, userId, userType }) => request(api.caseChatList, {
    params: {
...
export const changeCustomer = async ({ serviceUserId, userId }) => request.post(api.caseChangeCustomerService, {
  params: {
