...
export const listPlatformContent = async ({ pageNum, pageSize, createDateFrom, createDateTo,
  founderId, language, modifierId, type, updateDateFrom, updateDateTo }) =>
  request(api.platformList, {
    params: {
      ...
      pageNum, pageSize, createDateFrom, createDateTo,
      founderId, language, modifierId, updateDateFrom, updateDateTo
    },
  });
